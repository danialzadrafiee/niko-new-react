...
interface FundraiseState {
  ...
  updateFundraise: (id: number, data: Partial<Fundraise>) => Promise<void>
...
const useFundraiseStore = create<FundraiseState>((set) => ({
  ...
  createFundraise: async (data: FormData) => {
    try {
      ...
      showSuccessToast("Fundraise created successfully")
    } catch (error) {
  ...
  updateFundraise: async (id, data) => {
    try {
      const updatedFundraise = await fundraiseService.updateFundraise(id, data as any)
      set((state) => ({
        fundraises: {
          ...state.fundraises,
  ...
  deleteFundraise: async (id) => {
    try {
      ...
      showSuccessToast("Fundraise deleted successfully")
    } catch (error) {
