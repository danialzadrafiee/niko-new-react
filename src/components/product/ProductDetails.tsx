...
const ProductDetails: React.FC<ProductDetailsProps> = ({ product }) => {
  return (
    <div className="grid grid-cols-2 mobile:grid-cols-1 mobile:gap-6 gap-20 justify-between items-center">
      <div className="grid">
        <div className="text-xl font-semibold">{product.title}</div>
        <div className="truncate mobile:w-[300px] w-[400px]">{product.describe}</div>
