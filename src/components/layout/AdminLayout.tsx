...
import { LayoutDashboard, Package, FolderTree, Users, Menu, X, LogOut, ListOrdered, BarChart2, HeartHandshake, Settings, Sliders } from "lucide-react"
...
const AdminLayout: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex">
      ...
      {/* Sidebar */}
      <div
        className={`bg-[#5432a1] text-white w-64 space-y-6 py-7 px-2 fixed inset-y-0 left-0 z-20 transform ${sidebarOpen ? "translate-x-0" : "-translate-x-full"} md:relative md:translate-x-0 transition-transform duration-300 ease-in-out`}
      >
