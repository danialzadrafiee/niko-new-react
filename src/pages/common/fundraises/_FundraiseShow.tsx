...
import FundraiseHeader from "@/components/fundraise/FundraiseHeader"
import FundraiseProgress from "@/components/fundraise/FundraiseProgress"
import InvestForm from "@/components/fundraise/InvestForm"
import Status from "@/components/fundraise/Status"
...
const FundraiseShow: React.FC = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto">
      <div className="flex mobile:grid gap-[24px] w-full">
        <div className="w-[324px] mobile:order-2 mobile:w-full shrink-0">
        ...
        <div className="flex-grow">
          <div>
            ...
            <section>
              <div className="grid grid-cols-2 mobile:grid-cols-1 mt-8">
                ...
                <div className="grid gap-2 pr-10 mobile:pr-0 mobile:pt-5 mobile:border-b">
                  <InvestForm onSubmit={handleInvest} />
                </div>
              </div>
            </section>
          </div>
