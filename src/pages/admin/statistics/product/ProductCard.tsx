      ...
      <div className="flex flex-col md:flex-row md:items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm">
            ...
            <p className="font-medium text-gray-800">{product.price.toLocaleString()} تومان</p>
            <p className="text-gray-600">موجودی:</p>
            <p className="font-medium text-gray-800">{product.balance}</p>
      ...
      {product.fundraises && product.fundraises.length > 0 && (
        <div className="mt-6 bg-gray-50 p-4 rounded-lg">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm mb-3">
            ...
            <p className="font-medium text-gray-800">{product.fundraises[0].price_total.toLocaleString()} تومان</p>
            <p className="text-gray-600">جمع‌آوری شده:</p>
            <p className="font-medium text-gray-800">{product.fundraises[0].price_collected.toLocaleString()} تومان</p>
          </div>
          <Progress 
          ...
          <p className="text-right text-xs text-gray-500 mt-1">
            {product.fundraises[0].completion_percentage}% تکمیل شده
          </p>
        </div>
      )}
    </CardContent>
